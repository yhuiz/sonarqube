...
public class ContainsInComparatorTest {
  ...
  public void shouldCompareByResourceId() {
    ...
    assertThat(comparator.compare(newClonePart("a", 0), newClonePart("b", 0))).isEqualTo(-1);
    assertThat(comparator.compare(newClonePart("b", 0), newClonePart("a", 0))).isEqualTo(1);
    assertThat(comparator.compare(newClonePart("a", 0), newClonePart("a", 0))).isEqualTo(0);
  }
  ...
  public void shouldCompareByResourceIdAndUnitStart() {
    ...
    assertThat(comparator.compare(newClonePart("a", 0), newClonePart("a", 0))).isEqualTo(0);
    assertThat(comparator.compare(newClonePart("a", 0), newClonePart("a", 1))).isEqualTo(-1);
    assertThat(comparator.compare(newClonePart("a", 1), newClonePart("a", 0))).isEqualTo(1);
  }

  @Test
  public void shouldCompare() {
    assertThat(compare("a", 0, 0, "b", 0, 0)).isEqualTo(-1);
    assertThat(compare("b", 0, 0, "a", 0, 0)).isEqualTo(1);

    assertThat(compare("a", 0, 0, "a", 0, 0)).isEqualTo(0);
    assertThat(compare("a", 1, 0, "a", 0, 0)).isEqualTo(1);
    assertThat(compare("a", 0, 0, "a", 0, 1)).isEqualTo(-1);
  }
