...
public class PmdBlockChunkerTest {
  ...
  public void shouldBuildBlocks() {
    ...
    // assertThat(block.getLengthInUnits()).isEqualTo(11);
    assertThat(block.getStartLine()).isEqualTo(1);
    assertThat(block.getEndLine()).isEqualTo(2);
    assertThat(block.getBlockHash()).isEqualTo(new ByteArray(1L * 31 + 2));

    block = blocks.get(1);
    // assertThat(block.getLengthInUnits()).isEqualTo(33);
    assertThat(block.getStartLine()).isEqualTo(2);
    assertThat(block.getEndLine()).isEqualTo(3);
    assertThat(block.getBlockHash()).isEqualTo(new ByteArray(2L * 31 + 3));
  }
